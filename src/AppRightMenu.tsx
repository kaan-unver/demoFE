        ...
        <div className={classNames('layout-rightmenu', { 'layout-rightmenu-active': props.rightMenuActive })} onClick={props.onRightMenuClick}>
            ...
            <div className="user-detail-wrapper">
                <div className="user-detail-content">
                    <img src="assets/layout/images/dashboard/gene.png" alt="Demo" className="user-image" />
            ...
            <div>
                <Calendar mask='99/99/9999'  value={date} onChange={(e) => setDate(e.value)} inline></Calendar>
            </div>
