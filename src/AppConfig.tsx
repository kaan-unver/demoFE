        ...
        <div id="layout-config">
            ...
            <div className={classNames('layout-config', { 'layout-config-active': props.configActive })} onClick={props.onConfigClick}>
                ...
                <div className="field-radiobutton">
                    ...
                    <label id="horizontal">Horizontal</label>
                </div>
                <div className="field-radiobutton">
                    ...
                    <label id="sidebar">Sidebar</label>
                </div>
                <hr />
                ...
                <h5>Language</h5>
                <div className="field-radiobutton">
                    <RadioButton name="language" value="en" id="lan1" checked={props.language === 'en'} onChange={() => props.onLanguageChange('en')}></RadioButton>
                    <label>en</label>
                </div>
                <div className="field-radiobutton">
                    <RadioButton name="language" value="tr" id="lan2" checked={props.language === 'tr'} onChange={() => props.onLanguageChange('tr')}></RadioButton>
                    <label>tr</label>
                </div>
                <hr />
